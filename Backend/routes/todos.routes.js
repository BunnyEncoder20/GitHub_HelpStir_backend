...
router.route("/fetch").get(fetch_todo)          //Endpoint = localhost:8000/api/v1/todos/fetch || localhost:3000/api/v1/todos/fetch?id=1722608137096 || localhost:3000/api/v1/todos/fetch?sort=byCreatedDate.oldest
